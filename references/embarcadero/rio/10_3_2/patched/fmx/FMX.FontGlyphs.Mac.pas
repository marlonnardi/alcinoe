...
function TMacFontGlyphManager.DoGetGlyph(const Char: UCS4Char; const Settings: TFontGlyphSettings;
...
function TMacFontGlyphManager.IsColorfulCharacter(const Char: UCS4Char): Boolean;
begin
  Result := inherited or ((Char >= $1F0A0) and (Char <= $1F0FF)) or ((Char >= $1F300) and (Char <= $1F5FF)) or
