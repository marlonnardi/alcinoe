...
var
  ...
  var
    ...
    begin
      ...
      Alert.addButtonWithTitle(StrToNSStr(Translate(ButtonCaptions[B])));
    end;
  begin
...
begin
  ...
  try
    ...
    try
      ...
      Alert.setMessageText(StrToNSStr(Translate(MsgTitles[ADialogType])));
  ...
  try
    ...
    begin
      ...
      try
        ...
        Alert.addButtonWithTitle(StrToNSStr(Translate(ButtonCaptions[TMsgDlgBtn.mbOK])));
        Alert.addButtonWithTitle(StrToNSStr(Translate(ButtonCaptions[TMsgDlgBtn.mbCancel])));
