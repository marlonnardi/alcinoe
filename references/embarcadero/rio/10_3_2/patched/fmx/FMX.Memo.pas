...
uses
  ...
  {$IFDEF MSWINDOWS}, FMX.Memo.Win{$ENDIF}{$IFDEF IOS}, FMX.Memo.iOS{$ENDIF}{$IFDEF ANDROID}, FMX.Memo.Android{$ENDIF};
...
begin
  ...
  case CharCase of
    TEditCharCase.ecNormal:
      Insertion := AFragment;
    TEditCharCase.ecUpperCase:
      Insertion := AFragment.ToUpper;
    TEditCharCase.ecLowerCase:
      Insertion := AFragment.ToLower;
  end;
